...
const App: React.FC = () => {
    ...
    const showList = useSelector<todosState, todosState["showList"]>((state) => state.showList)
    const showInput = useSelector<todosState, todosState["showInput"]>((state) => state.showInput)
